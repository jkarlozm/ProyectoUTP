...
<input type="text" id="Editbox6" style="position:absolute;left:729px;top:205px;width:130px;height:22px;line-height:22px;z-index:13;" name="precio" value="" autocomplete="off">
<input type="text" id="Editbox7" style="position:absolute;left:729px;top:240px;width:130px;height:22px;line-height:22px;z-index:14;" name="hrsalida" value="" autocomplete="off">
<input type="text" id="Editbox8" style="position:absolute;left:730px;top:275px;width:130px;height:22px;line-height:22px;z-index:15;" name="nautobus" value="" autocomplete="off">
<input type="text" id="Editbox9" style="position:absolute;left:729px;top:310px;width:130px;height:22px;line-height:22px;z-index:16;" name="fsalida" value="" autocomplete="off">
<input type="text" id="Editbox10" style="position:absolute;left:729px;top:345px;width:130px;height:22px;line-height:22px;z-index:17;" name="lautobus" value="" autocomplete="off">
<input type="text" id="Editbox11" style="position:absolute;left:729px;top:380px;width:130px;height:22px;line-height:22px;z-index:18;" name="llibres" value="" autocomplete="off">
...
<input type="submit" id="Button2" name="" value="Agragar Producto" style="position:absolute;left:733px;top:491px;width:124px;height:25px;z-index:29;">
